...
/cvmfs/icecube.opensciencegrid.org/py2-v3.1.1/RHEL_7_x86_64/metaprojects/combo/V00-00-04/env-shell.sh /home/tmcelroy/icecube/domeff/process_splineMPE_2015_trackbias.py -g {} -d {} -r $1 -t .i3.zst -o {} -s True
...
transfer_input_files = domanalysis.py,event.py,general.py,geometry.py,process_splineMPE_2015_trackbias.py,writeEvent.py,writeEventRecoPulses.py
